---
title: "How to Play Junk in Golf: Rules & Scoring"
...
faq:
  ...
  - question: "Which Junk categories are fair for high handicappers?"
    answer: "Sandy, Barkie, and Chippie are the most skill-neutral categories — everyone finds trouble, and scrambling ability doesn't strictly correlate with handicap. Birdie and Eagle obviously favor lower handicaps. Closest to Pin (prox) is the least fair for high handicappers because it rewards the ability to hit greens in regulation, which is a low-handicap skill. If your group has a wide handicap spread, consider dropping prox and loading up on recovery-based categories."
  ...
  - question: "What happens when someone picks up in Junk?"
    answer: "A pickup voids any Junk categories that require holing out. Chippie (chip-in for par) is voided — you can't earn it without finishing the hole. Greenie is unaffected if you were on the green in regulation before picking up: the closest-to-pin result is already determined. Sandie and Barkie both require holing out, so a pickup voids those too. Most groups apply a max score (double bogey net) for the hole and void only the completion-dependent categories."
---
...
<QuickFacts>
  <Fact label="Players">2–8</Fact>
  <Fact label="Scoring">Achievement-based, gross score</Fact>
  <Fact label="Categories">6–10 per round</Fact>
  <Fact label="Common stakes">$0.25–$0.50 per dot</Fact>
  <Fact label="Also called">Dots, Trash, Garbage</Fact>
</QuickFacts>
...
**Know which categories favor low handicappers.** Not all dots are created equal across skill levels. Closest to Pin (prox) heavily rewards ball-striking ability — hitting greens in regulation consistently is a low-handicap skill, and high-handicap players almost never win prox bets. Greenie has the same skew on par 3s. On the other hand, Sandy and Barkie are more egalitarian — everyone finds bunkers and trees, and scrambling isn't strictly correlated with handicap. If your group has a wide handicap spread, consider dropping prox and loading up on recovery-based categories instead. Your 20-handicap friend will have a lot more fun.
...
<QA question="Which Junk categories are fair for high handicappers?">
Sandy, Barkie, and Chippie are the most skill-neutral categories — everyone finds trouble, and scrambling ability doesn't strictly correlate with handicap. Birdie and Eagle obviously favor lower handicaps. Closest to Pin (prox) is the least fair for high handicappers because it rewards the ability to hit greens in regulation, which is a low-handicap skill. If your group has a wide handicap spread, consider dropping prox and loading up on recovery-based categories.
</QA>
...
<QA question="What happens when someone picks up in Junk?">
A pickup voids any Junk categories that require holing out. Chippie (chip-in for par) is voided — you can't earn it without finishing the hole. Greenie is unaffected if you were on the green in regulation before picking up: the closest-to-pin result is already determined. Sandie and Barkie both require holing out, so a pickup voids those too. Most groups apply a max score (double bogey net) for the hole and void only the completion-dependent categories.
</QA>
