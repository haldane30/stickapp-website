...
faq:
  ...
  - question: "Can you play Nassau with 3 players?"
    answer: "Yes — three-player Nassau runs three separate 1v1 matches simultaneously, one between each pair of players. Justin, Jason, and Evan each have a front-nine bet, back-nine bet, and overall bet against the other two. That's six separate matches running at once. It works well and is common in groups where one player shows up solo or someone bails before the round. The math is the same as 1v1 Nassau; you just settle three pairs at the end instead of one."
---
...
> **Track your Nassau automatically with Stick** — the original three bets, every press, every press-the-press, with a line-item settlement showing exactly what everyone owes. [Download on the App Store →](https://apps.apple.com/us/app/stick-golf-betting/id6758226317?utm_source=stickapp.golf&utm_medium=website&utm_campaign=nassau-guide)
...
Press tracking gets messy fast. On hole 8 you might have the original, a press from hole 4, and a press-the-press from hole 7. Three different bets, three different standings. This is exactly the kind of thing people argue about, and exactly what an app should handle so you don't have to. For how 2026's updated rules — reduced ball movement penalties, free relief from any pitch mark — affect the underlying strokes in your Nassau, [here's the full breakdown](/blog/golf-rule-changes-2026-betting/).
...
Weighing Nassau against Skins or Wolf for your group? [The full comparison breaks down where each game fits →](/blog/nassau-vs-skins-vs-wolf/)
...
Yes — three-player Nassau runs three separate 1v1 matches simultaneously, one between each pair of players. Justin, Jason, and Evan each have a front-nine bet, back-nine bet, and overall bet against the other two. That's six separate matches running at once. It works well and is common in groups where one player shows up solo or someone bails before the round. The math is the same as 1v1 Nassau; you just settle three pairs at the end instead of one.
</QA>
...
[Download Stick →](https://apps.apple.com/us/app/stick-golf-betting/id6758226317?utm_source=stickapp.golf&utm_medium=website&utm_campaign=nassau-guide)
