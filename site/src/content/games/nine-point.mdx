---
title: "How to Play Nine Point: Rules & Scoring"
description: "Nine Point (5-3-1) is a three-player golf game where 9 points distribute per hole. Learn the rules, tie scenarios, blitz, and settlement."
gameName: "Nine Point"
players: "3 players"
...
faq:
  ...
  - question: "What happens when someone picks up in Nine Point?"
    answer: "A player who picks up scores zero points on that hole. The nine points still distribute among the players who completed the hole — if two players pick up and only one finishes, that player takes all nine by default. Most groups apply a max score rule (double bogey or worse) before a pickup registers as zero. Agree on the pickup rule before the round: it can meaningfully swing the point total on a hole where someone blows up early."
---
...
<QuickFacts>
  ...
  <Fact label="Common stakes">$1–$2 per point</Fact>
  <Fact label="Also called">Nines, 5-3-1, Nines Game</Fact>
</QuickFacts>
...
<QA question="What happens when someone picks up in Nine Point?">
A player who picks up scores zero points on that hole. The nine points still distribute among the players who completed the hole — if two players pick up and only one finishes, that player takes all nine by default. Most groups apply a max score rule (double bogey or worse) before a pickup registers as zero. Agree on the pickup rule before the round: it can meaningfully swing the point total on a hole where someone blows up early.
</QA>
