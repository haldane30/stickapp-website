---
title: "How to Play Quota in Golf: Rules & Points"
...
faq:
  ...
  - question: "How does Quota work for a golf outing or tournament?"
    answer: "Quota scales to any group size without extra setup. Everyone plays their own ball, earns gross points per hole, and compares their differential against every other player at the end. A 30-player outing across eight foursomes ranks all players on one leaderboard by differential — the person in Group 1 competes directly against the person in Group 8 without ever crossing paths. No flights, no brackets, no handicap flights to manage. This is why Quota is the default format for charity events, company outings, and club day competitions."
---
...
<QuickFacts>
  <Fact label="Players">2 to unlimited</Fact>
  <Fact label="Scoring">Gross (handicap sets your target, not per-hole score)</Fact>
  <Fact label="Common stakes">$1–$5 per point of differential</Fact>
  <Fact label="Also called">Chicago, Point Quota, Dogfight (older term)</Fact>
</QuickFacts>
...
This is why Quota is the default format for golf outings, leagues, and charity tournaments. It's why Justin's Wednesday group at the club runs it for 20-30 players every week. If you're planning a fivesome round, see the [five-player golf betting guide](/blog/best-golf-betting-games-5-players/) for how Quota fits alongside other games for that group size.
...
<QA question="How does Quota work for a golf outing or tournament?">
Quota scales to any group size without extra setup. Everyone plays their own ball, earns gross points per hole, and compares their differential against every other player at the end. A 30-player outing across eight foursomes ranks all players on one leaderboard by differential — the person in Group 1 competes directly against the person in Group 8 without ever crossing paths. No flights, no brackets, no handicap flights to manage. This is why Quota is the default format for charity events, company outings, and club day competitions.
</QA>
