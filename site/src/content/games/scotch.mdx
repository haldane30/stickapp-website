---
title: "How to Play Scotch Golf: Rules & Scoring"
description: "Scotch awards 6 points per hole across four categories. Learn the point system, umbrella sweeps, rolls, and see a full settlement walkthrough."
gameName: "Scotch"
...
faq:
  - question: "What is Scotch golf?"
    answer: "Scotch is a 2v2 team game where each hole distributes exactly 6 points across four categories: Low Ball (2 points), Low Total (2 points), Proximity (1 point), and Birdie (1 point). Teams accumulate points over 18 holes, and the final settlement is based on the point differential multiplied by your agreed dollar per point. Common stakes are $1–$5 per point."
  - question: "Why is it called 'Six-Point'?"
    answer: "Each hole awards exactly 6 points total across the four categories. The name comes directly from the core mechanic: 2 + 2 + 1 + 1 = 6 per hole. After 18 holes, one team typically ends up with significantly more points, and the difference gets multiplied by your dollar per point to calculate settlement. Some groups call it \"6-Point\" colloquially, which can cause confusion with Split Sixes (a three-player game also called 6-Point)."
  - question: "What does 'umbrella' mean in Scotch?"
    answer: "An umbrella (also called a sweep) happens when one team wins all four categories on a single hole. When that occurs, the 6 points double to 12. Umbrellas are rare but high-impact—one hole can shift the entire match momentum. You can toggle umbrellas on or off before the round."
  - question: "Is Scotch the same as Scotch Foursomes?"
    answer: "No. They're completely different games sharing a name. Scotch (this guide) is four-ball: both players play their own ball, 2v2 team, points system. Scotch Foursomes is alternate shot: one ball per team, players alternate hitting. Foursomes is scored as match play, not points. Always clarify which one before you play."
  - question: "What happens if two teams tie on Low Ball?"
    answer: "Tied categories award zero points to both teams—the points vanish. Some groups split tied points (1-1 instead of 0-0), but Stick uses the vanish model. It's cleaner math and keeps settlement straightforward. Move on to the next hole; you'll get your opportunities elsewhere."
  - question: "How do I settle Scotch at the end of the round?"
    answer: "Add up each team's total points across all 18 holes. Subtract to find the differential. Multiply by your agreed dollar per point — that's the total pot. Each winning player gets half the pot, each losing player pays half. If Team A wins by 8 points at $1/point, the pot is $8. Each Team A player gets $4, each Team B player pays $4. The math always nets to zero."
  - question: "What is a roll in Scotch?"
    answer: "A roll is a pre-shot doubling declaration by the trailing team. After the leading team tees off, the trailing team announces the roll before hitting their own tee shot. The leading team can accept (2x stakes on remaining holes) or drop (ending the round at the current deficit). Rolls stack multiplicatively — roll twice and you're at 4x."
  - question: "What's the difference between Low Ball and Low Total?"
    answer: "Low Ball is the single best individual net score on the hole—your team's better player's score. Low Total is the combined net scores of both teammates. A team can win Low Ball (score of 4 vs 5) but lose Low Total if their other player's score is high (4 + 6 = 10 vs 5 + 5 = 10—actually tied in this case). Both are worth 2 points each."
  - question: "Can I press in Scotch?"
    answer: "Pressing (starting a new side bet when you're down) is uncommon in Scotch but possible with house rules. Stick tracks the standard version without presses. Rolls serve a similar function—they escalate stakes for the remaining holes—but rolls are the default Scotch mechanic, not presses. Check with your group before playing if you want to add manual presses."
  - question: "What happens when a team picks up in Scotch?"
    answer: "Scotch is an alternate shot team game, so a pickup is a joint team decision — both partners concede the hole together. The opposing team automatically wins that hole's Low Ball and Low Total points. An individual player can't pick up on their own because the ball is shared. If the team is in a clearly unwinnable position — deep trouble with no realistic path to par — conceding is the practical move. It keeps pace and prevents a blowup score that inflates the Low Total gap for the rest of the round."
---
...
<QuickFacts>
  <Fact label="Players">4 (2v2 teams)</Fact>
  <Fact label="Scoring">Net or gross</Fact>
  <Fact label="Common stakes">$1–$5 per point</Fact>
  <Fact label="Also called">Six-Point, 6-Point Scotch, 6-Point Game</Fact>
  <Fact label="Format">Fixed partnerships for 18 holes</Fact>
</QuickFacts>
...
| Category | What It Means | Points | Winner |
|----------|--------------|--------|--------|
| **Low Ball** | Best individual net score | 2 | One team |
| **Low Total** | Combined team net scores | 2 | One team |
| **Proximity** | Closest to the pin (manual entry) | 1 | One team |
| **Birdie** | Team that made birdie(s) | 1 | One team |
...
|----------|--------|--------|
| Low Ball | Team B (Jason net 3 beats Justin net 4) | Team B +2 |
| Low Total | Team B (3+5=8 beats 4+5=9) | Team B +2 |
| Proximity | Team A (manual entry) | Team A +1 |
| Birdie | Neither team made birdie | 0 to both |
...
| Category | Winner | Points |
|----------|--------|--------|
| Low Ball | Team B (Jason net 3) | +2 |
| Low Total | Team B (8 vs 9) | +2 |
| Proximity | Team B | +1 |
| Birdie | Team B (Jason birdie) | +1 |
...
| Hole | Par | Justin | Evan | Jason | Todd | Low Ball | Low Total | Prox | Birdie | Team A | Team B |
|------|-----|--------|------|-------|------|----------|-----------|------|--------|--------|--------|
| 1 | 4 | 4 | 5 | 4 | 5 | Tie (0) | Tie (0) | A | — | 1 | 0 |
| 2 | 3 | 3 | 4 | 3 | 5 | Tie (0) | A (7v8) | B | — | 2 | 1 |
| 3 | 5 | 5 | 7 | 4 | 6 | B (4) | B (10v12) | B | B (Jason) | 0 | **12** |
| 4 | 4 | 4 | 5 | 5 | 4 | Tie (0) | Tie (0) | A | — | 1 | 0 |
| 5 | 3 | 2 | 4 | 3 | 4 | A (2) | A (6v7) | B | A (Justin) | 5 | 1 |
| 6 | 4 | 4 | 5 | 4 | 5 | Tie (0) | Tie (0) | A | — | 1 | 0 |
| | | | | | | | | | **6-hole total:** | **10** | **14** |
...
**Point differential: 52 – 44 = 8 points.**
**At $1/point: $8 total pot.**
...
Understanding [settlement](/guides/settlement/) is how you know you're getting the math right. At $2/point that same 8-point differential becomes $16 total — $8 per winner, $8 per loser. The dollar-per-point dial controls how much swings matter.

---

## The Roll: Doubling Stakes

Scotch includes one of golf's most dramatic mechanics: the roll. If you've seen the [hammer in TGL or Wolf](/blog/tgl-hammer-golf-betting/), the roll is a related concept — both let you double the stakes with a take-it-or-fold choice — but the timing is different. A hammer can be thrown mid-hole. A roll is a pre-shot declaration: you announce it before teeing off, not after seeing how the hole plays out.
...
| Scenario | Result |
|----------|--------|
| You roll, they take it, you win 2–1 the rest of the way | You gain back 2x what you'd have gained (instead of closing 3 points, you close 6) |
| You roll, they drop | Round ends. You take the current deficit as the final. |
...
Strokes apply on the hardest holes by [stroke index](https://www.usga.org/handicapping/roh/Content/rules/Appendix%20C%20Stroke%20Allocation.htm). Evan gets 15 strokes on the 15 hardest holes, wrapping. Jason gets 7 on the 7 hardest. Learn more about [how handicaps work](/guides/handicaps/) in golf betting. This is automatic in Stick — you enter gross scores and the app applies strokes.
...
**Scotch vs. [Nassau](/games/nassau/):** Nassau is three separate bets (front, back, overall) with match play scoring. You can lose the front and still win the round. Scotch is one continuous 18-hole point accumulation. No comeback mechanic mid-round—you're building to the final differential.

**Scotch vs. [Skins](/games/skins/):** Skins is individual, hole-by-hole. You compete solo or as a team, but each hole is independent. Scotch is 2v2 team, and points accumulate. Different pacing, different strategy.

**Scotch vs. [Match Play](/games/match-play/):** Match play goes "1 up," "2 up," etc.—it's about current lead. Scotch goes "Team A +14"—it's about total points. Both are team games, but Scotch has more continuous action (every hole creates several point opportunities).

**Scotch vs. [Sixes](/games/sixes/):** Sixes rotates partnerships every six holes. Scotch keeps the same teams for 18 holes. Sixes has halved matches where no money changes hands. Scotch gives you 6 points on every hole — there's no halve, no reset.

**Layering [Junk](/games/junk/) on Scotch:** Many groups run Junk (greenies, sandies, etc.) alongside Scotch as a separate side game. Stick tracks them independently in the same round.

---

<FAQ>

<QA question="What is Scotch golf?">
...
<QA question="Why is it called 'Six-Point'?">
...
<QA question="What does 'umbrella' mean in Scotch?">
...
<QA question="How do I settle Scotch at the end of the round?">
Add up each team's total points across all 18 holes. Subtract to find the differential. Multiply by your agreed dollar per point — that's the total pot. Each winning player gets half the pot, each losing player pays half. If Team A wins by 8 points at $1/point, the pot is $8. Each Team A player gets $4, each Team B player pays $4. The math always nets to zero.
</QA>

<QA question="What is a roll in Scotch?">
...
<QA question="What's the difference between Low Ball and Low Total?">
...
<QA question="Can I press in Scotch?">
...
<QA question="What happens when a team picks up in Scotch?">
Scotch is an alternate shot team game, so a pickup is a joint team decision — both partners concede the hole together. The opposing team automatically wins that hole's Low Ball and Low Total points. An individual player can't pick up on their own because the ball is shared. If the team is in a clearly unwinnable position, conceding is the practical move — it keeps pace and prevents a blowup score that inflates the Low Total gap for the rest of the round.
</QA>
