---
title: "How to Play Sixes in Golf: Rotating Partnerships & Settlement"
description: "Sixes (Hollywood) rotates partnerships every 6 holes so everyone teams up once. Learn best-ball scoring, presses, handicaps, and settlement math."
gameName: "Sixes"
players: "4 players"
difficulty: "Medium"
...
keywords:
  ...
  - sixes golf
  - hollywood golf
  - round robin golf game
  - rotating partners golf
faq:
  - question: "What is Sixes golf?"
    answer: "Sixes is a four-player game with rotating partnerships. You play three separate six-hole matches, switching partners between matches so everyone pairs with everyone exactly once. Each match uses best-ball match play scoring — your team's lower score per hole wins the hole. Common stakes are $5–$25 per match."
  - question: "How do partnerships rotate in Sixes?"
    answer: "Match 1 (holes 1–6): A & B vs C & D. Match 2 (holes 7–12): A & C vs B & D. Match 3 (holes 13–18): A & D vs B & C. Each player partners with each other player exactly once across 18 holes. Decide partnerships before the round or shuffle to randomize."
  - question: "What does 'up' mean in Sixes?"
    answer: "\"Up\" means winning. \"2 up\" means you're ahead by 2 holes. \"1 up with 2 to play\" means you're winning by 1 and there are only 2 holes left. The dormie rule: if you're up by as many holes as remain, you've won the match (opponent can only tie). \"All square\" or \"AS\" means tied."
  - question: "What is an auto-press in Sixes?"
    answer: "A new side bet that fires automatically when you're losing by a set threshold (default 2 holes down). It starts on the next hole and covers only the remaining holes in that match, beginning fresh at all square. The original bet still runs independently. Presses give the trailing team a second chance to win money back."
  - question: "How much does each player win or lose in Sixes?"
    answer: "Each loser pays each winner the match bet amount. If you win a $10 match, you receive $10 from each of the two opponents — that's $20 total. If you lose, you pay $10 to each of the two winners — that's $20 total. A halved match = no money. Multiply by three matches and you get the final settlement."
  - question: "What's the difference between gross and net Sixes?"
    answer: "Gross uses raw scores, no handicap adjustments. Net applies handicap strokes on the hardest holes. Gross only works if everyone's within a few strokes. Net lets groups with mixed ability stay competitive — a 20-handicap gets enough strokes to win holes. Net is standard for casual foursomes with ability spread."
  - question: "What's the difference between Sixes and Split Sixes?"
    answer: "Completely different games sharing the same name. Sixes is four players in rotating partnerships, using team best-ball match play (this guide). Split Sixes is three players competing individually, with 6 points awarded per hole (4 to low, 2 to middle, 0 to high). Different rules, different strategies, different settlement. Always clarify which one before you play."
  - question: "Can you press on every hole in Sixes?"
    answer: "Auto-presses fire only when you're down by the threshold (default 2 holes). You can't press manually on any hole — only the automatic threshold triggers the new bet. Some groups also cap the number of presses per match (e.g., \"max 2 presses\") or forbid new presses after a certain hole."
  - question: "What happens if Sixes ends tied 3-3?"
    answer: "A halved match. No money changes hands on that bet. You still settle the other two matches. Over the full 18, it's possible to win one match, lose one, and halve one. Each settles independently."
  - question: "Can you play Sixes with 3 players?"
    answer: "No — Sixes requires exactly 4 players. The game is built around rotating 2v2 partnerships: six holes with each possible pairing of a foursome. With 3 players that rotation doesn't work. For threesomes, Nine Point or Split Sixes are the right alternatives — both are specifically designed for three players and provide the same hole-by-hole competitive tension."
---
...
<QuickFacts>
  <Fact label="Players">4 (exactly)</Fact>
  <Fact label="Scoring">Match play, best-ball, net or gross</Fact>
  <Fact label="Common stakes">$5–$25 per match</Fact>
  <Fact label="Also called">Hollywood, Round Robin</Fact>
</QuickFacts>

## Why Partnerships Rotate (And Why It Matters)

Standard foursome golf locks you into one partnership for 18 holes. Sixes does the opposite — you get three different partners in one round, each for exactly six holes. It forces you to adapt and keeps the group from fracturing into "two good players carrying two weak ones." If you like the partner-selection tension of [Wolf](/games/wolf/) but want something more structured, Sixes is the answer.
...
**Total: $0.** Justin had the best day (+$40), Todd had the worst (-$40), and Jason and Evan broke even. The halved Match 3 kept it from being a blowout for Todd. Each match settles independently under [settlement](/guides/settlement/) rules.
...
This pressing structure is similar to how [Nassau presses work](/games/nassau/) — but in Sixes, each press is confined to a single six-hole match, not a full nine-hole segment.
...
**Off-low-man:** Lowest handicapper plays scratch. Others get the difference times the handicap allowance (default 100%, so full strokes). A group with handicaps 5, 12, 18, and 20 — the 5 plays scratch, the 12 gets 7, the 18 gets 13, the 20 gets 15. Read more about [how handicaps work in golf betting](/guides/handicaps/).

**Stroke allocation:** Strokes go on the hardest holes by [stroke index](https://www.usga.org/handicapping/roh/Content/rules/Appendix%20C%20Stroke%20Allocation.htm), wrapping for high handicaps. A 15-handicap gets strokes on the 15 toughest holes. An 18-handicap gets strokes on all 18, plus one extra on the three hardest. This is automatic in Stick and applied per hole as scores are entered.
...
**Running [Junk](/games/junk/) alongside.** Greenies, sandies, etc. Tracked as a separate game in Stick, not integrated into Sixes scoring.

## What New Players Get Wrong

**Confusing Sixes with [Nassau](/games/nassau/).** Nassau has three bets per nine (front, back, overall). Sixes has one bet per six-hole match. In Nassau, you're playing one partnership all 18 holes. In Sixes, you're switching partners every six. They're completely different games.
...
Sixes is the middle ground between individual and team games. Unlike [Skins](/games/skins/) (hole-by-hole individual bets), you have a teammate to lean on. Unlike [Match Play](/games/match-play/) (straight head-to-head), you're playing alongside someone, sharing the load.
...
<QA question="What is Sixes golf?">
...
<QA question="How do partnerships rotate in Sixes?">
...
<QA question="What does 'up' mean in Sixes?">
...
<QA question="What is an auto-press in Sixes?">
...
<QA question="How much does each player win or lose in Sixes?">
...
<QA question="What's the difference between gross and net Sixes?">
...
<QA question="Can you press on every hole in Sixes?">
...
<QA question="What happens if Sixes ends tied 3-3?">
...
<QA question="Can you play Sixes with 3 players?">
No — Sixes requires exactly 4 players. The game is built around rotating 2v2 partnerships: six holes with each possible pairing of a foursome. With 3 players that rotation doesn't work. For threesomes, [Nine Point](/games/nine-point/) or [Split Sixes](/games/split-sixes/) are the right alternatives — both are specifically designed for three players and provide the same hole-by-hole competitive tension.
</QA>
