...
Skins works for any number of players — from 2 to 8 or more. The sweet spot is 3–4 players, where ties happen often enough to build dramatic carryovers but not so often that skins rarely get awarded. With more players (6–8+), carryovers compound fast because tying is easier. Large groups typically use a pot format instead of pairwise settlement — everyone buys in, the pot divides by total skins won.
</QA>
