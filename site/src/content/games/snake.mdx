...
faq:
  - question: "What is the snake in golf?"
    answer: "Snake is a golf betting game where three-putts are penalties. The player who three-putts gets the snake (a liability). When the next player three-putts, the snake transfers to them and its value grows. At the end of 18 holes, whoever holds the snake pays every other player the accumulated value. In the fixed model, each three-putt adds a set dollar amount — so $1 per three-putt with 5 three-putts means the holder pays $5 to each opponent. It's a side game, meaning it runs alongside other bets like Nassau or Skins."
  ...
  - question: "What's the difference between fixed and doubling Snake?"
    answer: "In fixed, every three-putt adds a set dollar amount to the snake's value. At $1 per three-putt with 7 three-putts during the round, the snake is worth $7 — the holder pays $7 to each opponent. In doubling, the snake's value doubles on each three-putt: first = $1, second = $2, third = $4, fourth = $8, continuing exponentially. The holder pays the final accumulated value to each opponent. Doubling gets dramatic fast — use it only if everyone's comfortable with potential wild swings."
  ...
  - question: "What happens when someone picks up during a Snake round?"
    answer: "Picking up means not completing the hole — no three-putt, no snake transfer. The ball is lifted before a third putt is made, so the snake stays where it is. Same result if someone has a putt conceded before reaching three: no transfer. The snake only moves when a player makes three or more strokes on the green. A pickup is effectively a pass in Snake."
---
...
<QuickFacts>
  <Fact label="Players">2+ (works with any size group)</Fact>
  <Fact label="Type">Side bet (runs alongside other games)</Fact>
  <Fact label="Scoring">Pure putting — only three-putts matter</Fact>
  <Fact label="Common stakes">$1–$5 per three-putt (fixed), or doubling from $0.25–$1</Fact>
  <Fact label="Also called">Animal game, Zoo golf, Putting penalty</Fact>
</QuickFacts>
...
### Fixed (Per Three-Putt)

Every three-putt during the round adds a fixed dollar amount to the snake's value. You agree on the per-three-putt amount before teeing off — $1, $2, $5 — and the snake accumulates from there.

Four players, $1 per three-putt. Across 18 holes, 7 three-putts happen. The snake is worth $1 × 7 = $7. Todd is holding it at the end, so he pays $7 to Justin, $7 to Jason, $7 to Evan. That's $21 total out of Todd's pocket.

The math is always: **stake × total three-putts = snake value.** You know the per-three-putt cost going in; the only variable is how many three-putts happen during the round. High-handicap groups with shaky putting end up with a bigger snake. Low-handicap groups keep it modest. The game self-calibrates.
...
Justin, Jason, Evan, and Todd playing fixed Snake at $1 per three-putt. Here's every three-putt across 18 holes:

| Hole | Three-Putter | Snake Holder After | Snake Value |
|------|-------------|-------------------|-------------|
| 3 | Jason | Jason | $1 (1 three-putt) |
| 5 | Evan | Evan | $2 (2 three-putts) |
| 8 | Evan (again) | Evan (no transfer — already holding) | $3 (3 three-putts) |
| 10 | Justin | Justin | $4 (4 three-putts) |
| 13 | Todd | Todd | $5 (5 three-putts) |
| 14 | Jason | Jason | $6 (6 three-putts) |
| 17 | Todd | Todd | $7 (7 three-putts) |

Seven three-putts total. Each one added $1 to the snake's value, so the snake is worth $1 × 7 = $7. The snake changed hands five times. Todd three-putted on 17 and nobody three-putted on 18, so Todd is holding at the end.

**Settlement:** Todd pays $7 to Justin, $7 to Jason, $7 to Evan. Total out: $21 from Todd. Total in: $7 each to three players. Net: Justin +$7, Jason +$7, Evan +$7, Todd −$21. Zero-sum — understand [settlement](/guides/settlement/) and you know why every dollar won is a dollar lost.
...
**Forgetting to agree on the model beforehand.** You start the round, two people assume fixed, one person assumes doubling. By hole 6 when the snake passes, you're arguing about what it's worth. Settle this before you tee off. "$1 per three-putt, fixed" or "doubling starting at $1." Write it down if you're not sure.
...
In fixed, every three-putt adds a set dollar amount to the snake's value. At $1 per three-putt with 7 three-putts during the round, the snake is worth $7 — the holder pays $7 to each opponent. In doubling, the snake's value doubles on each three-putt: first = $1, second = $2, third = $4, fourth = $8, continuing exponentially. The holder pays the final accumulated value to each opponent. Doubling gets dramatic fast — use it only if everyone's comfortable with potential wild swings.
</QA>
...
<QA question="What happens when someone picks up during a Snake round?">
Picking up means not completing the hole — no three-putt, no snake transfer. The ball is lifted before a third putt is made, so the snake stays where it is. Same result if someone has a putt conceded before reaching three: no transfer. The snake only moves when a player makes three or more strokes on the green. A pickup is effectively a pass in Snake.
</QA>
