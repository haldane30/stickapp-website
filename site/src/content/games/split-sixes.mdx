...
faq:
  ...
  - question: "What happens when someone picks up in Split Sixes?"
    answer: "A player who picks up scores zero points on that hole. The 6 points still distribute among the players who completed the hole — if one player picks up, the remaining two compete for all 6 points as normal, with the usual 4-2-0 split. If two players pick up, the one who finished takes all 6. Agree on a max score rule (double bogey or worse triggers a pickup) before the round to avoid disputes."
---
...
<QuickFacts>
  <Fact label="Players">Exactly 3</Fact>
  <Fact label="Scoring">Net or gross, per hole</Fact>
  <Fact label="Common stakes">$0.50–$2 per point</Fact>
  <Fact label="Also called">English, Cricket, 6-Point Game</Fact>
</QuickFacts>
...
<QA question="What happens when someone picks up in Split Sixes?">
A player who picks up scores zero points on that hole. The 6 points still distribute among the players who completed the hole — if one player picks up, the remaining two compete for all 6 points as normal with the usual 4-2-0 split. If two players pick up, the one who finished takes all 6. Agree on a max score rule (double bogey or worse triggers a pickup) before the round to avoid disputes.
</QA>
