...
Off-low-man, same as [Nassau](/games/nassau/) and [Nine Point](/games/nine-point/). Lowest courseHandicap plays scratch, everyone else gets the difference. Strokes are allocated by [stroke index](https://www.usga.org/handicapping/roh/Content/rules/Appendix%20C%20Stroke%20Allocation.htm) — hardest holes first.
