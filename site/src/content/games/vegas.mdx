...
If you want to play net Vegas for mixed skill levels, apply handicap strokes by hole using the [USGA Course Handicap](https://www.usga.org/content/usga/home-page/handicapping/roh/Content/rules/Appendix%20C%20Handicap%20Allowances.htm) system. The difference in combined team handicaps determines total strokes for the higher-handicap team.
