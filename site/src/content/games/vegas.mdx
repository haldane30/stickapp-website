---
title: "How to Play Vegas in Golf: Score Pairing, Flips & Settlement"
...
```
Players: 4 (2v2 teams) or 3 (one player doubled)
Scoring: Paired digits, net or gross
Common stakes: $0.50-$1.00 per point
Also called: "Las Vegas," Daytona (variant)
```
