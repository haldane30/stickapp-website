---
title: "How to Play Vegas in Golf: Rules & Scoring"
description: "Vegas pairs team scores instead of adding them. Learn the 10+ rule, flip mechanics, carryovers, and see a full settlement walkthrough with real numbers."
gameName: "Vegas"
...
keywords:
  ...
  - vegas golf betting
  - golf flipping the bird
  - daytona golf game
faq:
  - question: "What is Vegas golf?"
    answer: "Vegas is a 2v2 team betting game where team scores are paired (concatenated) as two-digit numbers instead of added. A team with scores of 4 and 5 has a team score of 45, not 9. The difference between team scores determines points won each hole. It's called Vegas because wild swings are possible on any single hole, making for dramatic momentum shifts across 18 holes."
  - question: "How does the 10+ rule work?"
    answer: "When any player scores 10 or higher, that high number goes first in the pairing. So a score of 4 and 10 becomes 104 instead of 410. The rule exists to prevent massive point swings on blowup holes — it keeps the game playable even when someone has a disaster. It's almost universal in Vegas."
  - question: "What happens when both teams birdie?"
  ...
  - question: "What's the difference between Vegas and Daytona?"
    answer: "Vegas always pairs with the low number first (except the 10+ exception). Daytona uses par as a reference: if either player on the team is at par or better, low goes first. If both are over par, high goes first. Daytona is less common but used by some groups as a house rule variant."
  - question: "Can you play Vegas with three players?"
    answer: "Yes. The solo player's score is doubled to form a team score. A solo player shooting 5 has a team score of 55. If they birdie (shoot 3), the team score is 33. Three-player Vegas is acknowledged as unbalanced — the solo player is disadvantaged unless they're the best golfer — but it's the simplest method. Some groups rotate the solo player every 6 holes to share the pain."
  - question: "How does carryover work in Vegas?"
    answer: "Carryover is optional. When teams tie consecutive holes, a multiplier builds. If two holes tie, the next winning hole is multiplied by 3 (the win value times one-plus-the-tie count). Carryover amplifies the game significantly and must be agreed on before play starts. It resets when someone wins a hole."
  - question: "What is Flip the Bird in Vegas golf?"
    answer: "When your team makes a birdie and the other team doesn't on the same hole, you can flip (reverse) the opponent's paired score. So 46 becomes 64. If your team makes an eagle, you flip and also double the point differential. Flip is the most common house rule variant and creates dramatic momentum swings."
  - question: "How much should we play for?"
    answer: "Common stakes range from $0.25 per point (very casual) to $1.00 per point (moderate). A typical 18-hole swing is 10–30 points per hole, so $0.50 per point means potential holes worth $5–$15. High-stakes groups play $2–$5 per point. Agree on the amount before the first tee."
  - question: "How do handicaps work in Vegas golf?"
    answer: "Vegas can be played gross or net. Most casual groups play gross because the two-digit score pairing creates enough natural variance. When skill levels differ significantly — a 5-handicap paired against a 20-handicap, for instance — net Vegas applies off-low-man strokes by stroke index, the same system used in Nassau and Skins. Net scores substitute for gross in the pairing. If your group has a wide handicap spread, net keeps the game competitive; if everyone is within a few strokes of each other, gross is simpler."
---
...
<QuickFacts>
  <Fact label="Players">4 (2v2 teams) or 3 (one player doubled)</Fact>
  <Fact label="Scoring">Paired digits, net or gross</Fact>
  <Fact label="Common stakes">$0.50–$1.00 per point</Fact>
  <Fact label="Also called">Las Vegas, Daytona (variant)</Fact>
</QuickFacts>

## What Makes Vegas Different

Most golf betting games either add points ([Skins](/games/skins/)), count holes won ([Match Play](/games/match-play/)), or divide a round into segments ([Nassau](/games/nassau/)). Vegas does something simpler: every hole creates a raw point differential, and that differential rides all 18.
...
If you want to play net Vegas for mixed skill levels, apply [handicap strokes](/guides/handicaps/) by hole using the [USGA Course Handicap](https://www.usga.org/content/usga/home-page/handicapping/roh/Content/rules/Appendix%20C%20Handicap%20Allowances.htm) system. The difference in combined team handicaps determines total strokes for the higher-handicap team.
...
| Hole | Par | JJ Scores | JJ Pair | ET Scores | ET Pair | Flip? | Points | Carry | Points × Carry | Winner |
|------|-----|-----------|---------|-----------|---------|-------|--------|-------|----------------|--------|
| 1 | 4 | 4, 5 | 45 | 5, 6 | 56 | No | 11 | — | 11 | JJ +11 |
| 2 | 4 | 5, 5 | 55 | 4, 5 | 45 | No | 10 | — | 10 | ET +10 |
| 3 | 5 | 3B, 5 | 35 | 4, 6 | 46→64 | Yes | 29 | — | 29 | JJ +29 |
| 4 | 3 | 3, 4 | 34 | 3, 4 | 34 | No | 0 | 1 | 0 | **Tie** |
| 5 | 4 | 4, 5 | 45 | 5, 10 | 105 | No | 60 | 2 | 120 | JJ +120 |
| 6 | 4 | 5, 6 | 56 | 4, 5 | 45 | No | 11 | — | 11 | ET +11 |
...
**Vegas rule:** Low number always goes first (except 10+).
**Daytona rule:** If at least one player on the team is at par or better, low goes first. If both are over par, high goes first.
...
<QA question="What is Vegas golf?">
Vegas is a 2v2 team betting game where team scores are paired (concatenated) as two-digit numbers instead of added. A team with scores of 4 and 5 has a team score of 45, not 9. The difference between team scores determines points won each hole. It's called Vegas because wild swings are possible on any single hole, making for dramatic momentum shifts across 18 holes.
</QA>

<QA question="How does the 10+ rule work?">
...
<QA question="What happens when both teams birdie?">
When both teams have at least one birdie on the same hole, both flips cancel. The scores are paired normally and stand as-is. No flip from either side. This creates tension because the momentum swing that could have happened is blocked entirely, so players often describe it as "both birdies kill each other."
</QA>

<QA question="What's the difference between Vegas and Daytona?">
...
<QA question="Can you play Vegas with three players?">
...
<QA question="How does carryover work in Vegas?">
...
<QA question="What is Flip the Bird in Vegas golf?">
...
<QA question="How much should we play for?">
...
<QA question="How do handicaps work in Vegas golf?">
Vegas can be played gross or net. Most casual groups play gross because the two-digit score pairing creates enough natural variance. When skill levels differ significantly — a 5-handicap paired against a 20-handicap, for instance — net Vegas applies off-low-man strokes by stroke index, the same system used in [Nassau](/games/nassau/) and [Skins](/games/skins/). Net scores substitute for gross in the pairing. If your group has a wide [handicap](/guides/handicaps/) spread, net keeps the game competitive; if everyone is within a few strokes of each other, gross is simpler.
</QA>
