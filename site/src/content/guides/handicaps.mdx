...
faq:
  ...
  - question: "What if someone in my group doesn't have an official handicap?"
    answer: "Most Saturday foursomes have at least one player without a USGA or WHS handicap. The simplest solution is an estimated handicap — have the player average their last 3-5 rounds on comparable courses and use that as their course handicap. If they've never tracked scores, round-based estimates work: 0-5 over par is roughly a 5-12, 6-10 over is roughly 12-18, 11-15 over is roughly 18-24, and so on. Use your best read, play the round, and adjust for next time. Informal groups do this every weekend."
---
...
<QA question="What if someone in my group doesn't have an official handicap?">
Most Saturday foursomes have at least one player without a USGA or WHS handicap. The simplest solution is an estimated handicap — have the player average their last 3-5 rounds on comparable courses and use that as their course handicap. If they've never tracked scores, round-based estimates work: 0-5 over par is roughly a 5-12 handicap, 6-10 over is roughly 12-18, 11-15 over is roughly 18-24, and so on. Use your best read, play the round, and adjust for next time. Informal groups do this every weekend. If you want a more structured approach without signing up for a GHIN account, see [how settlement works](/guides/settlement/) to understand how the dollar math still balances regardless of how handicaps were established.
</QA>
