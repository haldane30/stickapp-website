...
| Game | Stick | Skins App | Beezer | 18 Birdies | Golf Bettor | GolfApp |
|------|-------|-----------|--------|------------|-------------|---------|
...
| **Quota** | 🔨 Building | ✅ | ✅ | ❌ | ❌ | ❌ |
| Banker | ❌ (post-launch) | ✅ | ✅ | ❌ | ✅ | ❌ |
| Stableford | ❌ (not building) | ✅ | ✅ | ❌ | ✅ | ❌ |
| Bingo Bango Bongo | ❌ (evaluating) | ❌ | ✅ | ❌ | ❌ | ❌ |
| Rabbit | ❌ (evaluating) | ❌ | ✅ | ❌ | ❌ | ❌ |
| Best Ball | ❌ (not building) | ❌ | ✅ | ❌ | ✅ | ❌ |
| Scramble | ❌ (not building) | ❌ | ⚠️ | ❌ | ✅ | ❌ |
| **TOTAL** | **12** (at launch) | **13+** | **~30** | **10** | **12** | **~4** |
...
| Feature | Stick | Skins App | Beezer | 18 Birdies |
|---------|-------|-----------|--------|------------|
| Press-the-press chains | ✅ Unlimited | ⚠️ Limited | ❌ | ❌ |
| Auto-press configurable | ✅ 2-down, custom | ⚠️ Basic | ❌ | ❌ |
| Wolf hammer mode | ✅ Full | ❌ | ❌ | ❌ |
| Zero-sum verification | ✅ 1,448 tests | Unknown | Unknown | Unknown |
| Multi-device real-time sync | ✅ Convex reactive | ⚠️ Basic | ❌ | ✅ |
| Integer cent arithmetic | ✅ No float errors | Unknown | Unknown | Unknown |
| Multi-game single scorecard | ✅ Any combination | ⚠️ Limited | ⚠️ Limited | ⚠️ Limited |
| Settlement transparency | ✅ Line-item breakdown | ⚠️ Summary only | ⚠️ Summary only | ⚠️ Summary only |
...
|-----|--------|-------------|-------------------|---|
| Skins App | ~4.5 | ~200 | Calculation errors, confusing UI | Feb 2026 |
| Beezer Golf | ~4.2 | ~50 | No free tier, crashes | Feb 2026 |
| 18 Birdies | ~4.6 | ~10K+ | Expensive ($100/yr), GPS focus | Feb 2026 |
| Golf Bettor | ~3.8 | ~30 | Outdated UI, limited games | Feb 2026 |
